...
.curso-main-container.pb-3
  ...
  .container.bg-white.p-md-5.p-4.container-bottom.mt-0.mb-5 
    ...
    .row.aling.my-5   
      .col-lg-8
        p.mb-3 Para ampliar la información alrededor de los tipos de sociedades en Colombia, se sugiere revisar los siguientes recursos.
              ...
              .row.justify-content-between.align-items-center
                ...
                .col-md-auto
                  a.boton.color-acento-botones(href="https://youtu.be/C45SM5MlqfU" target="_blank")
                    ...
                    .row
                      .col-auto
                        img.mx-1(src="@/assets/curso/images/tema1/ico_video.svg",  alt='', style="width:20px; display:block; margin:auto 0 ;")
    ...
    p.mb-5 Para definir el diagnóstico organizacional como herramienta estratégica para la organización, es necesario conocer el concepto de diagnóstico presentado en el siguiente video.
  ...
  .container.bg-white.p-md-5.p-4.container-bottom.mt-0.mb-0
    ...
    .row.align-items-center.justify-content-center.mb-3
      ...
      .col-lg-5(data-aos="fade-left") 
        img.mt-3(src='@/assets/curso/images/tema1/img_9.png')
      ...
      .py-3.py-md-4.tabs-c__content-item-1.tab-c.mg-top-2(titulo="Modelo de las cinco fuerzas")
        .row.justify-content-center.align-items-center.p-4 
          .col-12.col-md-6.mb-3.mb-md-0
            ...
            p - Rivalidad entre los competidores existentes en el sector. 
            p - Amenaza de entrada de nuevos competidores en el sector.
            p - Amenaza de aparición de productos sustitutivos en el sector. 
            p - Poder de negociación de los clientes.                                                                        
            p - Poder de negociación de los proveedores. 
      ...
      .py-3.py-md-4.tabs-c__content-item-1.tab-c.mg-top-2(titulo="Matriz POAM")
        .row.justify-content-center.align-items-center.p-4 
          .col-12.col-md-6.mb-3.mb-md-0
            ...
            p - Obtención de la información primaria y secundaria.
            p - Identificación de las oportunidades y amenazas.
            p - El grupo estratégico selecciona las áreas de análisis. 
            p - Priorización y calificación de los factores externos.
            p - Calificación del impacto.
            p - Elaboración de POAM.      
