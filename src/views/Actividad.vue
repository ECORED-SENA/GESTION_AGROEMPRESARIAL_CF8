  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch(data-aos="zoom-in-up")
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Reforzando conceptos sobre información, estadística y datos.
        p.mb-4 Reforzar los conceptos y habilidades en estadística para unidades productivas, con base en lo estudiado en componente formativo.
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch(data-aos="zoom-in-up")
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Profundizando en procesos estadísticos
        p.mb-4 Reforzar los conceptos y habilidades en estadística para unidades productivas, con base en lo estudiado en componente formativo.
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
